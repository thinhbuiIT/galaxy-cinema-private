    ...
    return (
        <footer className='footer bg-[#1A1A1A] flex justify-center p-[2rem_2rem_1rem_2rem] mt-5'>
            <div className="container">
                <div className="footer__head text-white flex gap-12 justify-between">
                    <div className="footer__content text-[#FFFFFFB3] ">
                ...
                <div className="footer__foot flex items-center gap-4 border-t-[1px solid gray] text-[#FFFFFFB3]">
